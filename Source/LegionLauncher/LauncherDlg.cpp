...
void LauncherDlg::OnTimer(UINT_PTR nIDEvent)
{
	...
	case TIMER_LOOP:
		if(!updater.isrunning)
		{
			...
			if(updater.error != "")
			{
				string error = "There was a problem running the updater. Please restart the launcher to try again. If the problem persists, visit our website (www.helbreathlegion.net) or forums for more help. \n\nError details:\n";
				error += updater.error;
